...
normalise origin target value
  ...
  | 0 == diff origin = error
    "Cannot normalise a value that has no minimum and maximum value."
  | let (l, h) = origin in (l > value || h < value) = error
    "Cannot normalise a value outside of the given range."
