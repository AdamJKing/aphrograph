...
readPixel point = CanvasUpdate . ReaderT $ \(Canvas underlying) ->
        readArray underlying point
...
paintPoint p = CanvasUpdate . ReaderT $ \(Canvas underlying) ->
        writeArray underlying p 'X'
